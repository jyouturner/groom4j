...
from researcher.llm_interaction import extract_key_findings
...
class TestLLMInteraction(unittest.TestCase):
    ...
    def test_update_key_findings(self):
        ...
        from researcher.llm_interaction import update_key_findings
    ...
    def test_query_llm(self, mock_remove_next_steps, mock_extract_findings, mock_extract_steps):
        ...
        from researcher.llm_interaction import query_llm
    ...
    def test_extract_and_process_next_steps(self):
        ...
        from researcher.llm_interaction import extract_and_process_next_steps
    ...
    def test_shoud_continue_conversation(self):
        ...
        from researcher.llm_interaction import shoud_continue_conversation
