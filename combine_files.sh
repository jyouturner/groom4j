...
print_usage() {
    echo "Usage: $0 [-p project_root] [-o output_name] [-t] [-s] [-e exclude_pattern]"
    echo "Options:"
...
while getopts "p:o:tse:" opt; do
    case $opt in
        ...
        e) exclude_patterns="$exclude_patterns $OPTARG";;  # Add to exclude patterns
...
should_exclude_file() {
    ...
    # Check user-specified exclude patterns
...
if [ -n "$exclude_patterns" ]; then
    echo "Debug: Exclude patterns:$exclude_patterns"
fi
